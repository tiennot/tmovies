...
public class Stats {
	...
	//Retweets
	public static long TWEETS_RETWEET = 0;
	...
	//Tweets error SQL
	public static long TWEETS_SQLERROR = 0;
	
	public static void printStats(){
		System.out.println("===============Stats===============");
		System.out.println("TWEETS_TOTAL..............."+TWEETS_TOTAL);
		System.out.println("TWEETS_RETWEET............."+TWEETS_RETWEET);
		...
		System.out.println("TWEETS_SQLERROR............"+TWEETS_SQLERROR);
		System.out.println("===================================");
	}
}
